...
<html lang="en">
  ...
  <body>
    <h1 class="text-center p-3">Agregar Especialidad</h1>
    <div class="container-fluid">
        <form method="POST">
            ...
            <div class="mb-3">
                <label for="inputNombre" class="form-label">Nombre Especialidad</label>
            ...
            <?php
                if(!empty($_POST["btnRegistrar"])){
                    ...
                    $controller->create($_POST["idEspecialidad"],$_POST["nombreEspecialidad"]);
                }
            ?>
        </form>
    </div>
